...
Rails::Initializer.run do |config|
  ...
  config.action_controller.session = {
    :session_key => '_ngodb_session',
    :secret      => 'd8667be44760f8c2ce2b0d2def1f134002f84f26a2c7040f9def04cbd707be65fc881fda760cbc0e795b83784a3be876872b5f3410c3a133645bf85af94f6d89'
  }
